 ...
 *
 * Inline SVG and not an image: the CSP is `script-src 'self'` with nothing remote, and a
 ...
 *
 * Schematic on purpose — boxes where the cards are, a bar where the rail is. A screenshot
