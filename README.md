...
<img src="src-tauri/icons/128x128@2x.png" width="104" alt="DevNotes">
...
[**Download**](https://github.com/vmillet-dev/devnotes-rs/releases/latest) · [Features](#features) · [Security](#security) · [Code quality](#code-quality) · [Build from source](#build-from-source)
